...
名单按微信空间和唯一备注/昵称区分, 不保证识别改名关系. 当前每份快照最多 10000 人、每个名字 512 UTF-8 字节、正文 1 MiB, 超限拒绝而不截断. 联系人缓存加密保存在本机, 清空消息保留好友, 断开配对清除好友. 已有会话的好友可直接进入聊天; 没有已接收会话的好友暂不能主动发消息. 首次同步及真实名单完整性由真机验收确认.
